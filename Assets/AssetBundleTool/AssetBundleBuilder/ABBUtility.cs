...
namespace AssetBundleBuilder
{
    ...
    {
        public const string Menu_GlobalBuildWindow = "AssetBundle/AssetBundleBuilder/GlobalBuild";
        public const string Menu_SelectBuildWindow = "AssetBundle/AssetBundleBuilder/SelectBuild";
